...
package io.mariachi.allianzvision.camera.api14;
...
import io.mariachi.allianzvision.camera.base.AspectRatio;
import io.mariachi.allianzvision.camera.base.CameraViewImpl;
import io.mariachi.allianzvision.camera.base.Constants;
import io.mariachi.allianzvision.camera.base.PreviewImpl;
import io.mariachi.allianzvision.camera.base.Size;
import io.mariachi.allianzvision.camera.base.SizeMap;
...
//                });
    ...
    public void adjustCameraParameters() {
        ...
        if (currentSize.width != size.getWidth() || currentSize.height != size.getHeight()) {
            ...
            //ken
            mCameraParameters.setPreviewFpsRange(29000, 29000);
            ...
            mPreview.setOnTouchEvent(this);

            try {
                mCamera.setPreviewDisplay(mPreview.getSurfaceHolder());
                log("Se le asigno el preview");
            } catch (IOException e) {
                e.printStackTrace();
            }
